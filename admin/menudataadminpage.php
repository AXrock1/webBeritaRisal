                            ...
                            <div class="card border-0">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="tambahadminpage.php" class="btn btn-primary fw-bold">Tambah Admin</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" style="margin-top:40px;">
                                                                <a href="editadminpage.php?id=<?= $data['id'] ?>" class="btn btn-primary" style="width:50px; font-size:12px; margin:2px;">Edit</a>
                                                                <a href="deleteadmin.php?id=<?= $data['id'] ?>" class="btn btn-danger delete-link" style="width:70px; font-size:12px; margin:2px;">Delete</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
