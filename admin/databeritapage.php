            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark ">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <a href="# " class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                        <h2 class="fw-bold d-none d-sm-inline" style="border-bottom:1px solid white; width:100%;">DASHBOARD</h2>
                    </a>
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        <li>
                            ...
                            <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                                <li class="w-100">
                                    <a href="databeritapage.php" class="nav-link px-0 text-light" style="font-size:15px;"> <span class="d-none d-sm-inline">Berita</span> <i class="bi bi-clipboard-data"></i></a>
                                </li>
                                <li>
                                    <a href="menudataadminpage.php" class="nav-link px-0 text-light" style="font: size 15px;"> <span class="d-none d-sm-inline">Admin</span> <i class="bi bi-person-fill"></i> </a>
                                </li>
                                <li>
                                    <a href="dataulasanpage.php" class="nav-link px-0 text-light" style="font: size 15px;"> <span class="d-none d-sm-inline">Ulasan </span><i class="bi bi-graph-up"></i></a>
                                </li>
                                <li>
                            ...
                            <div class="card border-0">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="tambahberitapage.php" class="btn btn-primary fw-bold">Tambah Berita</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" style="margin-top:30px;">
                                                                <a href="editberitapage.php?id_berita=<?= $data['id_berita'] ?>" class="btn btn-primary" style="width:50px; font-size:12px; margin:2px;">Edit</a>
                                                                <a href="deleteberita.php?id_berita=<?= $data['id_berita'] ?>" class="btn btn-danger delete-link" style="width:70px; font-size:12px; margin:2px;">Delete</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php
