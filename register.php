          ...
          <div class="card-body">
            <form action="registerproccess.php" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-4">
                ...
                <input type="text" name="pekerjaan" id="pekerjaan" class="form-control" required="required">
              </div>
              <div class="mb-4">
                <label for="password_user" class="form-label">Password</label>
                <input type="password" name="password_user" id="password_user" class="form-control" required="required">
              </div>
              <div class="mb-4">
